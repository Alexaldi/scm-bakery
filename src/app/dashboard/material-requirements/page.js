  ...
  return (
    <div>
      <PageHeader
        ...
        description="Material requirement dihitung dari forecast quantity dikali BOM quantity per product, lalu dikonversi ke unit inventory dan diagregasi per bahan baku."
        actions={
      ...
      <section className="mb-6 rounded-lg border border-gray-200 bg-white">
        <div className="border-b border-gray-200 px-5 py-4">
          <h2 className="text-base font-semibold text-gray-900">Forecast Disetujui</h2>
        </div>
      ...
      <div className="grid gap-6 xl:grid-cols-[1.1fr_0.9fr]">
        <section>
          <h2 className="mb-3 text-base font-semibold text-gray-900">Detail Perhitungan Produk ke Bahan</h2>
            ...
            <table className="min-w-full divide-y divide-gray-200 text-sm">
              <thead className="bg-gray-50">
                <tr>
                  ...
                  <th className="px-4 py-3 text-right font-semibold text-gray-700">Forecast</th>
        ...
        <section>
            ...
            <table className="min-w-full divide-y divide-gray-200 text-sm">
              <thead className="bg-gray-50">
                <tr>
                  ...
                  <th className="px-4 py-3 text-right font-semibold text-gray-700">Gross Requirement</th>
          ...
          <div className="mt-4 rounded-lg border border-blue-200 bg-blue-50 p-4">
            <p className="text-sm font-semibold text-blue-900">Ringkasan Gross Requirement</p>
            <p className="mt-1 text-sm text-blue-800">
              {result.aggregated.length} bahan baku dihitung. Data tersimpan saat tombol Hitung Kebutuhan Bahan ditekan.
            </p>
          </div>
          <div className="mt-4 rounded-lg border border-gray-200 bg-white p-4">
            <p className="text-sm font-semibold text-gray-900">Data MRP Tersimpan</p>
